...
// getPatientNameById(int id) 			return type string
// getPatientContactNoByName(String name)		

//deletePatientByGender(Gender gender);



//id,name, type, quantity
//getOrderNameById(int id)
//getOrderQuantities();				//in[] getOrderQuantities; 		coz of more than one quantity
//getOrderNames();					// String[] getOrderNames;

hotel - food items
id name, type, price;
updateFoodPriceByName;
updateFoodPriceById;
getAllFoodNames 			String[]
deleteFoodNameById
deleteFoodItemsByType
